...
if __name__ == '__main__':
    path_video = input("Please Enter video path (input *local* to use local camera):")
    path_out = input("Please Enter output path:")
    detect_video(YOLO(),video_path = path_video)